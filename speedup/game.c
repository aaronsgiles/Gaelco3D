...
void GameInit(GameSavedData *data)
{
	...
	romTexture[6] = malloc(TEXMASK_ROM_SIZE);
	memset(romTexture[6], 0, TEXMASK_ROM_SIZE);
	romTexture[7] = malloc(TEXMASK_ROM_SIZE);
	memset(romTexture[7], 0, TEXMASK_ROM_SIZE);
...
void Write68000(UINT32 address, UINT32 data, int size)
{
	switch (address)
	{
		...
		case 0x510105:	// serial (1)
		case 0x510107:	// unknown (1)
		case 0x510117:	// tms_control3_w (1)
		case 0x510127:	// unknown (1)
		case 0x510137:	// unknown (1)
		case 0x510147:	// led (1)
		case 0x510177:	// led (1)
			if (size != 1) goto Unknown;
			break;
		
		case 0x510044:	// unknown (2)
			if (size != 2) goto Unknown;
			break;
